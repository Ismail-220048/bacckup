...
<head>
    ...
    <title>Manage Officials | CivicTrack India</title>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                ...
                <div class="card-header">
                    <h3><i class="fa fa-plus-square-o"></i> Add New Official</h3>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3><i class="fa fa-shield"></i> All Officers (<?php echo count($officersList); ?>)</h3>
                </div>
                                ...
                                <tr id="officer-row-<?php echo $oid; ?>">
                                    ...
                                    <td><span class="badge" style="background:var(--primary-dark);"><?php echo htmlspecialchars($o['department'] ?? 'General'); ?></span>
                                        <div style="font-size: 0.70rem; color: var(--text-muted); margin-top: 2px;">
                                            <?php echo ($o['role'] ?? 'officer') === 'senior_officer' ? '<i class="fa fa-star-o"></i> Senior Officer' : 'Field Officer'; ?>
                                        </div>
                                    </td>
                                     ...
                                     <td>
                                        <div class="action-btns">
                                            <?php if ($role !== 'district_admin'): ?>
                                                <button class="btn btn-danger btn-sm" onclick="deleteOfficer('<?php echo $oid; ?>')"><i class="fa fa-trash-o"></i> Delete</button>
                                            <?php else: ?>
