<?php
/**
 * ReportMyCity — Senior Officer Profile
 */
session_start();
if (!isset($_SESSION['user_id']) || !in_array($_SESSION['role'], ['senior_officer', 'district_admin', 'state_admin'])) {
...
$collection = $headOfficersCol = $db->getCollection('head_officers');
...
try {
    ...
    echo "Invalid officer ID."; exit;
}
if (!$userDoc) { echo "Officer not found."; exit; }

$userName  = $userDoc['name']  ?? 'Senior Officer';
$userEmail = $userDoc['email'] ?? '';
$userPhone = $userDoc['phone'] ?? '';
$userPhoto = $userDoc['photo'] ?? '';
$department = $userDoc['department'] ?? 'Department Head';
...
<head>
    ...
    <title>My Profile — ReportMyCity Senior Officer</title>
    ...
    <style>
        ...
        .profile-avatar-container:hover .profile-avatar-preview { filter: brightness(0.85); }
        .avatar-edit-btn {
            position: absolute;
            bottom: 5px;
            right: 5px;
        ...
        .avatar-edit-btn:hover { transform: scale(1.1); background: var(--gov-gold-light); }
        .profile-info-lite h2 { margin-bottom: 0.25rem; font-size: 1.25rem; }
        .profile-info-lite p  { color: var(--text-muted); font-size: 0.85rem; margin-bottom: 1.5rem; }
        .account-badge {
            display: inline-flex;
            align-items: center;
            gap: 0.5rem;
        ...
        .section-header h3 { margin: 0; font-family: var(--font-serif); color: var(--gov-navy); }
        ...
        .btn-premium:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(10,37,88,0.35); }
        ...
        <aside class="sidebar">
            <div class="sidebar-brand">
                <div class="sidebar-brand-inner">
                    ...
                    <div class="sidebar-brand-text">
                        ...
                        <span>Head Officer Console</span>
                    </div>
                </div>
            </div>
            ...
            <nav class="sidebar-nav">
                ...
                <a href="dashboard.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : ''; ?>">
                    <span class="nav-icon"><i class="fa fa-bar-chart-o"></i></span> Team Overview
                </a>
                <a href="my_department.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'my_department.php' ? 'active' : ''; ?>">
                    <span class="nav-icon"><i class="fa fa-list-alt"></i></span> Dept. Complaints
                </a>
                <a href="manage_team.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'manage_team.php' ? 'active' : ''; ?>">
                    <span class="nav-icon"><i class="fa fa-users"></i></span> Manage Team
                </a>
                <a href="workforce_tree.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'workforce_tree.php' ? 'active' : ''; ?>">
                    <span class="nav-icon"><i class="fa fa-sitemap"></i></span> Workforce Tree
                </a>
                <a href="heatmap.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'heatmap.php' ? 'active' : ''; ?>">
                    <span class="nav-icon"><i class="fa fa-map-marker"></i></span> Heatmap
                </a>
                <a href="profile.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'profile.php' ? 'active' : ''; ?>">
                    <span class="nav-icon"><i class="fa fa-user-circle"></i></span> My Profile
                </a>
                ...
                <a href="my_department.php?status=Audit%20Requested" style="color:#ef4444;">
                    <span class="nav-icon"><i class="fa fa-flag"></i></span> Conduct Audits
                </a>
            </nav>
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <div class="user-info">
                ...
                <span id="header-name">Welcome, <?php echo htmlspecialchars($userName); ?></span>
                <!-- Profile Dropdown -->
                ...
                <aside class="profile-sidebar-card">
                    <div class="profile-avatar-container">
                        <div class="profile-avatar-preview" id="profile-preview-box">
                            <?php if ($userPhoto): ?>
                                <img src="../<?php echo htmlspecialchars($userPhoto); ?>" style="width:100%; height:100%; object-fit:cover;">
                            <?php else: ?>
                    ...
                    <div class="profile-info-lite">
                        ...
                        <div class="account-badge"><i class="fa fa-shield"></i> Senior Officer</div>
                    </div>
                    <div style="margin-top: 2rem; text-align: left; padding: 1rem; background: #fdf2f2; border-radius: 10px; font-size: 0.8rem; color: var(--text-muted);">
                        <div style="margin-bottom: 0.5rem;"><strong>Dept:</strong> <?php echo htmlspecialchars($department); ?></div>
                        <div style="margin-bottom: 0.5rem;"><strong>Role:</strong> <?php echo htmlspecialchars(ucwords(str_replace('_', ' ', $_SESSION['role']))); ?></div>
                    ...
                    <form id="profileForm">
                        ...
                        <div class="form-group">
                            <label for="password">Change Password
                                <small style="font-weight: 400; color:var(--text-muted);">(Leave blank to keep current)</small>
                            </label>
...
<script>
    ...
    photoInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            reader.onload = function(event) {
                ...
                previewBox.innerHTML = `<img src="${uploadedPhotoBase64}" style="width:100%; height:100%; object-fit:cover;">`;
            };
    ...
    document.getElementById('profileForm').addEventListener('submit', async function(e) {
        ...
        const payload = { name, email, phone, photo: uploadedPhotoBase64 };
