<?php
/**
 * CivicTrack India — National Admin: Comprehensive Workforce Tree
 */
session_start();
...
<head>
    ...
    <title>National Workforce Tree | CivicTrack</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            <div class="page-header">
                <h1><i class="fa fa-sitemap"></i> National Personnel Hierarchy</h1>
                                            ...
                                            <div class="tier-fo">
                                                <?php foreach ($ho['children'] as $fo): ?>
                                                    <div class="node-card" style="padding: 0.5rem 0.8rem;">
                                                        <i class="fa fa-user-o" style="font-size: 0.8rem;"></i>
