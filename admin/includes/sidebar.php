<aside class="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <a href="manage_complaints.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'manage_complaints.php' ? 'active' : ''; ?>">
            <i class="fa fa-list-alt"></i> Complaints
        </a>
        ...
        <a href="manage_officer_reports.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'manage_officer_reports.php' ? 'active' : ''; ?>">
            <i class="fa fa-shield"></i> Officer Audits 
        ...
        <a href="manage_user_reports.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'manage_user_reports.php' ? 'active' : ''; ?>">
            <i class="fa fa-flag-o"></i> Fake Audits 
            <?php if($userRCount > 0): ?>
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="user-info">
                ...
                <span class="sidebar-user-role"><i class="fa fa-globe"></i> <?php echo ucwords(str_replace('_', ' ', $_SESSION['role'] ?? 'admin')); ?></span>
            </div>
        </div>
        <a href="../logout.php" class="logout-link" style="color:var(--danger); display:block; text-align:center; margin-top:0.8rem; font-size:0.85rem; text-decoration:none;"><i class="fa fa-sign-out"></i> Logout</a>
    </div>
</aside>
