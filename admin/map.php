            ...
            <div class="card" style="margin-top: 1rem;">
                <div class="map-stats-bar">
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <span style="color: #ef4444;"><i class="fa fa-circle"></i></span>
                        <strong id="stat-pending">0</strong> Pending
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <span style="color: #3b82f6;"><i class="fa fa-circle"></i></span>
                        <strong id="stat-progress">0</strong> In Progress
                    </div>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <span style="color: #10b981;"><i class="fa fa-circle"></i></span>
                        <strong id="stat-resolved">0</strong> Resolved
                    </div>
                    <div style="margin-left: auto; font-size: 0.85rem; color: var(--text-muted);">
                        <i class="fa fa-info-circle"></i> Click pins for details
                    </div>
                </div>
                ...
                if(res.success && res.data && res.data.length > 0) {
                    ...
                    res.data.forEach(point => {
                        ...
                        const icon = L.divIcon({
                            ...
                            html: `<div style='background-color:${color};' class='marker-pin'></div><i class='fa fa-exclamation'></i>`,
                            iconSize: [30, 42],
                            iconAnchor: [15, 42]
                        });
