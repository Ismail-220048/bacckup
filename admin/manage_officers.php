    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            ...
            <div class="card" style="border-top: 4px solid var(--primary);">
                <div class="card-header">
                    <h3><i class="fa fa-university"></i> Regional State Administrators (<?php echo count($stateAdminsList); ?>)</h3>
                </div>
                            ...
                            <tbody>
                                <?php foreach ($stateAdminsList as $o): $oid = (string)$o['_id']; ?>
                                 <tr id="officer-row-<?php echo $oid; ?>">
                                    ...
                                    <td><span style="font-size: 0.75rem;"><i class="fa fa-shield"></i> State Level</span></td>
                                    <td><?php echo htmlspecialchars($o['created_at'] ?? '—'); ?></td>
                                     <td>
                                        <button class="btn btn-danger btn-sm" onclick="deleteOfficer('<?php echo $oid; ?>')"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
            ...
            <div class="card" style="margin-top: 2rem;">
                <div class="card-header">
                    <h3><i class="fa fa-shield"></i> Regional Field Officers (Head & Local)</h3>
                </div>
