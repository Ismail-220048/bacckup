<?php
/**
 * CivicTrack API — AI Conversational Agent
 */
session_start();
...
if (strpos($message, 'MY_LOCATION:') === 0) {
    ...
    if (empty($list)) {
        ...
        $suggestions = [['label' => '📢 File Complaint', 'value' => 'report_complaint']];
    } else {
    ...
    switch ($state) {
        case 'idle':
            if (stripos($message, 'report') !== false || stripos($message, 'complaint') !== false) {
                ...
                $suggestions = [['label' => '📍 Use Live Location', 'value' => 'report_complaint']];
            } else {
                $reply = "I'm not sure how to respond to that, but I'm great at filing complaints! Would you like to report an issue?";
                $suggestions = [['label' => '📢 Report Issue', 'value' => 'report_complaint']];
            }
            break;
        ...
        case 'awaiting_title':
            ...
            $suggestions = [
                ['label' => '🛣️ Road & Infrastructure', 'value' => 'Road & Infrastructure'],
                ['label' => '🗑️ Waste Management', 'value' => 'Waste Management'],
        ...
        case 'awaiting_description':
            ...
            $suggestions = [
                ['label' => '✅ Yes, Submit it', 'value' => 'CONFIRM_SUBMIT'],
                ['label' => '❌ No, Cancel', 'value' => 'CANCEL_SUBMIT']
            ];
