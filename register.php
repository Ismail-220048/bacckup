<?php
/**
 * CivicTrack — Multi-Step User Registration Page
 */
session_start();
...
<head>
    ...
    <meta name="description" content="CivicTrack — Create your citizen account to start reporting civic issues.">
    <title>Citizen Registration — CivicTrack Official Portal</title>
...
<div class="auth-gov-header">
    ...
    <div class="portal-text">
        <h1>CivicTrack — Citizen Registration</h1>
