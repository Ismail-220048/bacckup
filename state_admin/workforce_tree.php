<?php
/**
 * CivicTrack India — State Admin: Workforce Hierarchy View
 */
session_start();
...
<head>
    ...
    <title>State Workforce Hierarchy | CivicTrack</title>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="manage_departments.php"><i class="fa fa-building-o"></i> Departments</a>
                <a href="manage_officers.php"><i class="fa fa-users"></i> Manage Personnel</a>
                <a href="workforce_tree.php" class="active"><i class="fa fa-sitemap"></i> Workforce Tree</a>
                <a href="manage_complaints.php"><i class="fa fa-file-text-o"></i> Complaints</a>
            ...
            <div class="grid" style="display: grid; grid-template-columns: 1fr; gap: 2rem;">
                ...
                <?php else: ?>
                    <?php foreach ($hierarchy as $dept => $heads): ?>
                        <div class="tree-card">
                            <div class="dept-title"><i class="fa fa-university"></i> <?php echo htmlspecialchars($dept); ?></div>
