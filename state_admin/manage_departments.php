<?php
/**
 * CivicTrack India — State Admin: Manage Departments
 */
session_start();
...
<head>
    ...
    <title>Manage Departments | CivicTrack India</title>
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="header-left">
                    ...
                    <h1><i class="fa fa-building-o"></i> Manage Departments (<?php echo htmlspecialchars($state); ?>)</h1>
                </div>
                <div class="user-info">
            ...
            <div class="grid" style="display: grid; grid-template-columns: 1fr 2fr; gap: 2rem;">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3><i class="fa fa-plus"></i> Create New Department</h3>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3><i class="fa fa-list"></i> Active Departments</h3>
                    </div>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <button class="btn btn-primary btn-sm" onclick="showAddHeadModal('<?php echo (string)$dept['_id']; ?>', '<?php echo htmlspecialchars($dept['name'], ENT_QUOTES, 'UTF-8'); ?>')">
                                            <i class="fa fa-user-plus"></i> Add Head Officer
                                        </button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
    ...
    <div id="addHeadModal" class="modal-overlay">
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fa fa-user-md"></i> Add Department Head</h3>
