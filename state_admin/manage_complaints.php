...
// Get all officers for assignment dropdown (filtered by same region as admin)
$officerFilter = [];
if ($role === 'state_admin') {
...
$allOfficers = $officersCol->find($officerFilter, ['sort' => ['name' => 1]]);
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div class="header-left">
                    ...
                    <h1><i class="fa fa-list-alt"></i> Manage Complaints (<?php echo htmlspecialchars($_SESSION['state'] ?? 'State'); ?>)</h1>
                </div>
                <div class="user-info">
    ...
    <script>
        ...
        function applyFilters() {
            ...
            let url = 'manage_complaints.php?status=' + status;
            if (state) url += '&state_filter=' + encodeURIComponent(state);
            if (district) url += '&district_filter=' + encodeURIComponent(district);
